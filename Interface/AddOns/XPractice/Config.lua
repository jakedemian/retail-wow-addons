...
-- Default 1279.5.
XPRACTICE.Config.SCREEN_WIDTH=1279.5

-- Default 720.
-- Resizing the screen may break some menus.
...
XPRACTICE.Config.FrameStrata="DIALOG"
...
-- the smaller your screen, the faster the camera rotates.
...
-- be sure to adjust CameraSpeed above after changing this value.
