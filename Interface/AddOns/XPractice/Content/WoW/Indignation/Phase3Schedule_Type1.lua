...
--TODO: FF6 type1 melee sometimes got thrown wrong direction after followup Shattering Pain -- no repro -- unsolved

do
	XPRACTICE.INDIGNATION.Phase3Schedule_Type1={}
	local schedule=XPRACTICE.INDIGNATION.Phase3Schedule_Type1
	--local XPRACTICE.INDIGNATION.Phase3Schedule_Type1.phase3starttime=60*6+43.28
	XPRACTICE.INDIGNATION.Phase3Schedule_Type1.DEFAULTSTARTTIME=60*6+51.28
	...
	local function CalcDelay(casttime)
		--print("delay:",casttime-XPRACTICE.INDIGNATION.Phase3Schedule_Type1.phase3starttime)		
		return casttime-XPRACTICE.INDIGNATION.Phase3Schedule_Type1.phase3starttime
	end

	function schedule.Run(sc)
		--XPRACTICE.INDIGNATION.Phase3Schedule_Type1.phase3starttime=60*6+43.28
		
		-- --!!!--------------
		if(DEBUG_FASTSTART)then

			XPRACTICE.INDIGNATION.Phase3Schedule_Type1.phase3starttime=(60*9+28.51)--BP3
			sc.ravagecount=2
		...
		sc:ShatteringPainCallbackAfterDelay(function()																									
								sc.aftersoakcallback=function()
									sc:SetCamp(sc.bosscamp,{x=math.cos(0)*5,y=math.sin(0)*5})
									sc:BossToCamp()
									sc:GroupToAngle(sc.mirrorgroup,sc.bosscamp,0,math.pi/16,maxmelee,minmelee,standardminreact,standardmaxreact)
									--sc:GroupToAngle(sc.rangedgroup,sc.bosscamp,-math.pi/6,math.pi/32,35,20,standardminreact,standardmaxreact)
									sc:GroupToAngle(sc.rangedgroup,sc.bosscamp,0,math.pi/64,15,10,standardminreact,standardmaxreact)
									sc:GroupFaceCamp(sc.allplayers,sc.bosscamp)									
								end
								sc:RepeatPreviousDropSeedsCallback()
		...
		sc:FunctionAfterDelay(function()
									...
									sc:SetCamp(sc.rangedcamp,{x=3.07,y=31.80})
		...
		sc:FunctionAfterDelay(function()
								--sc:SetCamp(sc.rangedcamp,{x=-5.44,y=4.49})								
								sc:SetCamp(sc.rangedcamp,{x=-1.02,y=15.27})					
								sc:GroupSpreadCamp(sc.rangedgroup,sc.rangedcamp,5,0.1,0.5)
								--TODO LATER: chance of CPU switching to "near" drop if player rolls ASAP to "far" drop
								-- only seems to affect schedule type1; type2 is too far away to get there in time
		...
		sc:ShatteringPainCallbackAfterDelay(function()																																		
									sc.aftersoakcallback=function()
										--print("FF3/SP4 aftersoak")
										--ranged moves first, approach OLD bosscamp position!
										sc:GroupApproachCamp(sc.rangedgroup,sc.bosscamp,31,26,0,0)										
										sc:SetCamp(sc.bosscamp,CSC( 9344.62 , -1884.74 )) --!!!
										sc:BossToCamp()		--!!!
										sc:GroupToAngle(sc.mirrorgroup,sc.bosscamp,math.pi/2+math.pi/8,math.pi/8,maxmelee,minmelee,standardminreact,standardmaxreact)																				
										--sc:GroupApproachCamp(sc.rangedgroup,sc.bosscamp,31,21,0,0)
										--sc:GroupApproachCamp(sc.rangedgroup,sc.bosscamp,21,15,standardminreact,standardmaxreact)	
										sc:GroupFaceCamp(sc.allplayers,sc.bosscamp)		
										sc.denathrius:FaceTowardsTank1Destination()
									end
		...
		sc:BloodPriceCallbackAfterDelay(function()
									--print("BP2 callback, set ranged camp")
		...
		sc:ShatteringPainCallbackAfterDelay(function()																									
							sc.aftersoakcallback=function()
								--sc:SetCamp(sc.bosscamp,{x=-10.91,y=12.25})
								--sc:SetCamp(sc.bosscamp,{x=-2.73,y=10.38})
								sc:SetCamp(sc.bosscamp,{x=-6.34,y=5.78})
								sc:BossToCamp()					
								--sc:GroupToAngle(sc.mirrorgroup,sc.bosscamp,math.pi/2-math.pi/8,math.pi/8,maxmelee,minmelee,standardminreact,standardmaxreact)
								sc:GroupToAngle(sc.mirrorgroup,sc.bosscamp,math.pi/2-math.pi/4,math.pi/8,maxmelee,minmelee,standardminreact,standardmaxreact)
								sc:GroupApproachCamp(sc.rangedgroup,sc.bosscamp,21,15,standardminreact,standardmaxreact)						
								sc:SetCamp(sc.rangedcamp,{x=-31.60,y=5.0})	
								sc:GroupSpreadCamp(sc.rangedgroup,sc.rangedcamp,2.5,standardminreact,standardmaxreact)																
								sc:GroupFaceCamp(sc.allplayers,sc.bosscamp)		
								sc.denathrius:FaceTowardsTank1Destination()
							end
		...
		sc:FunctionAfterDelay(function()
				...
				--sc:SetCamp(sc.rangedcamp,{x=-10.18,y=-17.40})
				--sc:SetCamp(sc.rangedcamp,{x=-10.40,y=-21.23})
				sc:SetCamp(sc.rangedcamp,{x=-10.46,y=-16.16})
				
				--sc:GroupSpreadCamp(sc.rangedgroup,sc.rangedcamp,5,0.25,0.5)				
				sc:GroupSpreadCamp(sc.rangedgroup,sc.rangedcamp,5,0.25,1.0)				
				--sc:SetCamp(sc.mirrorcamp,{x=-17.83,y=-9.02})
				--sc:SetCamp(sc.mirrorcamp,{x=-25.21,y=-8.44})
				sc:SetCamp(sc.mirrorcamp,{x=-24.57,y=-12.13})
				sc:GroupSpreadCamp(sc.mirrorgroup,sc.mirrorcamp,5,0.5,1.5)										
				--sc:SetCamp(sc.bosscamp,{x=-11.84,y=6.40})
				sc:SetCamp(sc.bosscamp,{x=-11.91,y=1.84})
				sc:BossToCamp(0.1)	
				--sc:GroupFaceCamp(sc.allplayers,sc.bosscamp)
				sc:GroupFaceCamp(sc.allplayers,sc.bosscamp)		
		...
		sc:ShatteringPainCallbackAfterDelay(function()	
				--sc:SetCamp(sc.bosscamp,CSC( 9346.53 , -1891.92 ))
				--sc:SetCamp(sc.bosscamp,{x=-14.82,y=-5.58})
				--sc:SetCamp(sc.bosscamp,{x=-1.82,y=-3.10})
				sc:SetCamp(sc.bosscamp,{x=-6.82,y=-6.32})
				sc:BossToCamp()	
				...
				sc:SetCamp(sc.rangedcamp,{x=-14.76,y=-28.71})
				--sc:GroupSpreadCamp(sc.rangedgroup,sc.rangedcamp,2.5,0,0)
		...
		sc:ClickButtonAfterDelay(sc.fatalfinessebutton,CalcDelay(60*9+01.79)) --FF5
				sc:FatalFinesseCallbackAfterDelay(function()				
								...
								--sc:SetFFCamp(sc.ffrangedcamp,sc.rangedcamp,{x=-3.98,y=-4.78},{x=0.55,y=-14.53})
								sc:SetFFCamp(sc.ffrangedcamp,sc.rangedcamp,{x=4.39,y=-16.67},{x=10.72,y=-27.82})
								
								--sc:SetCamp(sc.rangedcamp,{x=-13.03,y=-29.43})
								--sc:SetCamp(sc.rangedcamp,{x=-14.57,y=-24.38})
								--sc:SetCamp(sc.rangedcamp,{x=-17.71,y=-16.93})
								
								--sc:SetFFCamp(sc.ffmirrorcamp,sc.bosscamp,CSC( 9328.95 , -1910.75 ))
								 --sc:SetFFCamp(sc.ffmirrorcamp,sc.bosscamp,CSC( 9328.95 , -1910.75 ))
								 sc:SetFFCamp(sc.ffmirrorcamp,sc.bosscamp,{x=-29.38,y=-6.52},{x=-25.06,y=-18.79})
								sc:SendFFPlayersToCamp(seedminreact,seedmaxreact)
								sc:GroupFaceCamp(sc.allplayers,sc.bosscamp)
				...
				sc:AfterSoakCallbackAfterDelay(function()
								...
								--sc:SetCamp(sc.bosscamp,{x=2.06,y=-27.29})
								--sc:BossToCamp()
								--sc:GroupToAngle(sc.mirrorgroup,sc.bosscamp,math.pi*1.5+math.pi/4,math.pi/8,maxmelee,minmelee,standardminreact,standardmaxreact)
								sc:GroupToAngle(sc.mirrorgroup,sc.bosscamp,math.pi*0.5+math.pi/8,math.pi/8,maxmelee,minmelee,standardminreact,standardmaxreact)
								--sc:GroupApproachCamp(sc.rangedgroup,sc.bosscamp,15,10,standardminreact,standardmaxreact)
								sc:GroupToAngle(sc.rangedgroup,sc.bosscamp,math.pi*1-math.pi/12,math.pi/32,15,10,standardminreact,standardmaxreact)
								sc:GroupFaceCamp(sc.allplayers,sc.bosscamp)
											end,CalcDelay(60*9+01.79))	
		...
		sc:ShatteringPainCallbackAfterDelay(function()	
				...
				--sc:SetCamp(sc.bosscamp,{x=-2.01,y=-26.21})
				sc:SetCamp(sc.bosscamp,{x=4.02,y=-23.66})
				sc:BossToCamp()	
				sc:GroupToAngle(sc.mirrorgroup,sc.bosscamp,math.pi*1.5+math.pi/4,math.pi/8,maxmelee,minmelee,0,0)
				sc:SetCamp(sc.rangedcamp,CSC( 9349.27 , -1933.07 ))
				--sc:GroupApproachCamp(sc.rangedgroup,sc.bosscamp,15,10,standardminreact,standardmaxreact)
				sc:GroupApproachCamp(sc.rangedgroup,sc.bosscamp,20,15,standardminreact,standardmaxreact)
				sc:GroupFaceCamp(sc.allplayers,sc.bosscamp)	
		...
		sc:BloodPriceCallbackAfterDelay(function()	
				...
				--sc:SetCamp(sc.bosscamp,{x=-2.01,y=-26.21})
				--sc:SetCamp(sc.bosscamp,{x=4.02,y=-23.66})
				sc:SetCamp(sc.bosscamp,{x=-5.43,y=-27.32})
				sc:BossToCamp()	
				--sc:GroupToAngle(sc.mirrorgroup,sc.bosscamp,math.pi*1.5+0*math.pi/4,math.pi/6,maxmelee,minmelee,0,0)
				sc:GroupToAngle(sc.mirrorgroup,sc.bosscamp,math.pi*1.25+0*math.pi/4,math.pi/6,maxmelee,minmelee,0,0)
				--sc:SetCamp(sc.rangedcamp,CSC( 9332.84 , -1901.48+5+10 ))
				sc:SetCamp(sc.rangedcamp,{x=-17.78,y=-6.89})
				sc:GroupSpreadCamp(sc.rangedgroup,sc.rangedcamp,2.5,standardminreact,standardmaxreact)	
				sc:GroupFaceCamp(sc.allplayers,sc.bosscamp)				
		...
		sc:FatalFinesseCallbackAfterDelay(function()
				...
				sc:SetFFCamp(sc.ffrangedcamp,sc.rangedcamp,{x=-19.11,y=-20.49},{x=-29.28,y=-16.09})
				...
				sc:SetFFCamp(sc.ffmirrorcamp,sc.bosscamp, {x=-1.26,y=-13.56} , {x=-6.14,y=-2.88})
				--print("to camp")
		...
		sc:ShatteringPainCallbackAfterDelay(function()			
							...
							sc.aftersoakcallback=function()		
								...
								sc:SetCamp(sc.bosscamp,{x=-13.75,y=-19.55})
								sc:BossToCamp()
								...
								--sc:SetCamp(sc.rangedcamp,{x=-2.58,y=-7.10})
								sc:SetCamp(sc.rangedcamp,{x=-1.77,y=-8.59})
								sc:GroupSpreadCamp(sc.rangedgroup,sc.rangedcamp,2.5,standardminreact,standardmaxreact)	
		...
		sc:FatalFinesseCallbackAfterDelay(function()
				...
				sc.ffmirrorcamp[1]={x=-17.81,y=-32.23}
				if(#mirrorseedplayers>1)then sc.ffmirrorcamp[2]={x=-5.96,y=-31.64} else sc.ffmirrorcamp[2]=nil end				
				...
				sc.ffrangedcamp[1]={x=-17.82,y=-5.19}
				if(#rangedseedplayers>1)then sc.ffrangedcamp[2]={x=6.13,y=-23.14} else sc.ffrangedcamp[2]=nil end
				sc:SendFFPlayersToCamp(seedminreact,seedmaxreact)
				sc:GroupFaceCamp(sc.allplayers,sc.bosscamp)
		...
		sc:FunctionAfterDelay(function()
				...
				sc:GroupToAngle(sc.mirrorgroup,sc.bosscamp,math.pi+math.pi/4,math.pi/2,maxmelee,minmelee,standardminreact,standardmaxreact)	
				...
				sc:SetCamp(sc.rangedcamp,{x=-7.89,y=-9.93})
	...
	function schedule.StartFromMidway(sc,ffcount)
		...
		if(ffcount==1)then
			XPRACTICE.INDIGNATION.Phase3Schedule_Type1.phase3starttime=60*7+03.93
		...
		elseif(ffcount==2)then		
			--XPRACTICE.INDIGNATION.Phase3Schedule_Type1.phase3starttime=(60*7+22.14) --SP2		
			XPRACTICE.INDIGNATION.Phase3Schedule_Type1.phase3starttime=(60*7+32.76)
		...
		elseif(ffcount==3)then			
			XPRACTICE.INDIGNATION.Phase3Schedule_Type1.phase3starttime=(60*7+53.73) --SR1
		...
		elseif(ffcount==4)then
			XPRACTICE.INDIGNATION.Phase3Schedule_Type1.phase3starttime=(60*8+16.86) --BP2
			sc.ravagecount=1
		...
		elseif(ffcount==5)then
			XPRACTICE.INDIGNATION.Phase3Schedule_Type1.phase3starttime=(60*8+53.27) --SR2
			sc.ravagecount=1
		...
		elseif(ffcount==6)then
			...
			sc:SetCamp(sc.rangedcamp,{x=-11.60,y=-15.04})								
			sc:GroupSpreadCamp(sc.rangedgroup,sc.rangedcamp,2.5,standardminreact,standardmaxreact)																			
			--sc:GroupApproachCamp(sc.rangedgroup,sc.bosscamp,15,10,standardminreact,standardmaxreact)
		...
		sc.phasetime=XPRACTICE.INDIGNATION.Phase3Schedule_Type1.phase3starttime-(60*6+43.28)
