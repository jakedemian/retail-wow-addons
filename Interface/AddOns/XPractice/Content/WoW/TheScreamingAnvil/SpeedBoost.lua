...
do
	do	
		...
		XPRACTICE.PAINSMITH.Spell_Sprint=XPRACTICE.inheritsFrom(super)
		local class=XPRACTICE.PAINSMITH.Spell_Sprint
	...
	do	
		...
		XPRACTICE.PAINSMITH.SprintVisualEffect=XPRACTICE.inheritsFrom(super)
		local class=XPRACTICE.PAINSMITH.SprintVisualEffect
	...
	do	
		local super=XPRACTICE.Spell
		XPRACTICE.PAINSMITH.Spell_Roar=XPRACTICE.inheritsFrom(super)
		local class=XPRACTICE.PAINSMITH.Spell_Roar
	...
	do	
		local super=XPRACTICE.WoWObject
		XPRACTICE.PAINSMITH.RoarVisualEffect=XPRACTICE.inheritsFrom(super)
		local class=XPRACTICE.PAINSMITH.RoarVisualEffect
