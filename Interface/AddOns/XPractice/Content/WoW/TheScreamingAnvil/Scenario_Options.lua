do
	...
	XPRACTICE.PAINSMITH.Scenario_Options=XPRACTICE.inheritsFrom(super)
	local class=XPRACTICE.PAINSMITH.Scenario_Options
	
	local savedataname="PAINSMITH"
	
	function class:SetCustomInfo()
		super.SetCustomInfo(self)
		self.parentscenario=XPRACTICE.PAINSMITH.Scenario
	end
