...
do
	do	
		...
		XPRACTICE.KELTHUZADMULTIPLAYER.Spell_Sprint=XPRACTICE.inheritsFrom(super)
		local class=XPRACTICE.KELTHUZADMULTIPLAYER.Spell_Sprint
	...
	do	
		...
		XPRACTICE.KELTHUZADMULTIPLAYER.SprintVisualEffect=XPRACTICE.inheritsFrom(super)
		local class=XPRACTICE.KELTHUZADMULTIPLAYER.SprintVisualEffect
	...
	do	
		local super=XPRACTICE.Spell
		XPRACTICE.KELTHUZADMULTIPLAYER.Spell_Roar=XPRACTICE.inheritsFrom(super)
		local class=XPRACTICE.KELTHUZADMULTIPLAYER.Spell_Roar
	...
	do	
		local super=XPRACTICE.WoWObject
		XPRACTICE.KELTHUZADMULTIPLAYER.RoarVisualEffect=XPRACTICE.inheritsFrom(super)
		local class=XPRACTICE.KELTHUZADMULTIPLAYER.RoarVisualEffect
