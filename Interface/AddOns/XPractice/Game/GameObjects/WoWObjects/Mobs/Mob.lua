do
	...
	function class:SetCustomInfo()
		...
		self.defaultspeechbubbleduration=2.0
	...
	function class:GetNewYawTurnAtSpeed(targetyaw,elapsed,turnspeed,oldyaw)
		...
		--if(self:Isa(XPRACTICE.TERROROFCASTLENATHRIA.LanternGhost))then	print("old",oldyaw,"target",targetyaw,"diff",difference)	end
