...
do
	...
	-- static global
	function XPRACTICE.AnimationTemplate.QuickSetup(animationlist,name,index,subindex,priority,duration,nextanimation)
...
do
	...
	function class:TryCompleteDirectedSpellcast()
		--TODO: NYI TryCompleteDirectedSpellcast
	end	
