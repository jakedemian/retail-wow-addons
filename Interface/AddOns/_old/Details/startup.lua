...
--> initialize
	...
	print("|CFFFF0000[|cFF00FF11Details!|r]: you're using |cFFFFFF00'Details! Damage Meter for Shadowlands Beta'|r.")
	print("|CFFFF0000[|cFF00FF11Details!|r]: this version is deprecated, bugged, showing wrong numbers and isn't receiving updates any more.")
	print("|CFFFF0000[|cFF00FF11Details!|r]: please unistall it and install |cFFFFFF00'Details! Damage Meter'|r.")
